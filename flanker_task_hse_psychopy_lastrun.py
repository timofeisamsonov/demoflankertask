...
expName = 'flanker_task_hse_psychopy'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/larisa/Desktop/flanker_task_hse_psychopy_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='welcome to Flanker task experiment\n\nthe real thing is about to begin, remember this:\n\n1) You should press A any time you see X and C in the center of the screen\n\n2) You should press L any time you see B or V in the center of the screen\n\nfor right answers a green cross will appear, and red for mistakes\nsome practice might be required first\n\npress any key to continue',
        font='Open Sans',
    ...
    # Set experiment start values for variable component corr_amount
    corr_amount = 0
    corr_amountContainer = []
    ...
    # --- Initialize components for Routine "amount_corr_answers" ---
    ...
    text_6 = visual.TextStim(win=win, name='text_6',
        text='The number of your successfull attempts:',
        font='Open Sans',
    ...
    text_4 = visual.TextStim(win=win, name='text_4',
        text="We thank you for participation!\n\nDon't forget your Target/Pyatorochka discount on your way out",
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=1.0, 
        languageStyle='LTR',
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('source.xlsx'),
    ...
    for thisTrial in trials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('flanker_trial.started', globalClock.getTime())
        text_2.setText(flanker)
        key_resp_2.keys = []
        key_resp_2.rt = []
        _key_resp_2_allKeys = []
        # keep track of which components have finished
        flanker_trialComponents = [text_2, key_resp_2]
        for thisComponent in flanker_trialComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        for thisComponent in flanker_trialComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('flanker_trial.stopped', globalClock.getTime())
        # check responses
        ...
        text_3.setColor(concolor, colorSpace='rgb')
        # keep track of which components have finished
        responseComponents = [text_3]
    ...
    # --- Prepare to start Routine "amount_corr_answers" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('amount_corr_answers.started', globalClock.getTime())
    text_5.setText(corr_amount)
    # keep track of which components have finished
    amount_corr_answersComponents = [text_5, text_6]
    for thisComponent in amount_corr_answersComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # --- Run Routine "amount_corr_answers" ---
    routineForceEnded = not continueRoutine
    ...
    # --- Ending Routine "amount_corr_answers" ---
    for thisComponent in amount_corr_answersComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('amount_corr_answers.stopped', globalClock.getTime())
    # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
    if routineForceEnded:
        routineTimer.reset()
    else:
    ...
    thisExp.addData('corr_amount.endExpVal', corr_amount)  # Save end experiment value
